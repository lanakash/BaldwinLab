# -*- coding: utf-8 -*-
"""
Created on Sun Nov 26 23:20:41 2017
...
EnrichDate = 'June26'    #input('Enter string of enrichment batch desired with no space ei. "May16":')
    ...
    for day in list(set(dataFil['Day'])):   
        ...
        for dilu in [1, 10, 100]:
            ...
            for i in dataDayDilu.index:  
                ...
                s = s_dye[s_dye['FITC-A']>np.exp(6.6)]
                #s = s[s['PI/PE-Cy5.5-A']>np.exp(7)]
                #######################################################
...
countData = countData.sort_values('Day')
...
for samp in nameList:
    ...
    plt.plot(plotData100['Day'], plotData100['Count']/50*1000, 'ok')
